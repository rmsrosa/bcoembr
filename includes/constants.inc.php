...
$acervas = array_merge(array(NULL),array_map('trim',explode(',',$_SESSION['prefsACervAs'])));

$tie_break_rules = array("|Not Used","TBTotalPlaces|The highest total number of First, Second and Third Places", "TBTotalExtendedPlaces|The highest total number of First, Second, Third, Fourth, and Honorable Mention Places", "TBFirstPlaces|The highest number of First Places", "TBNumEntries|The lowest number of entries", "TBMinScore|The highest minimum score", "TBMaxScore|The highest maximum socre", "TBAvgScore|The highest average score", "TBRandom|(Pseudo-)Random choice generated by the system");
