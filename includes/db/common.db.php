...
// end if (NHC)
	...
	if (empty($_SESSION['prefs'.$prefix_session])) {	
		...
		$_SESSION['prefsRestrictedACervA'] = $row_prefs['prefsRestrictedACervA'];
		$_SESSION['prefsACervAs'] = $row_prefs['prefsACervAs'];
		$_SESSION['prefsShowACervA'] = $row_prefs['prefsShowACervA'];
